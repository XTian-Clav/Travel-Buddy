...
require_once 'models/elnido_model.php';
require_once 'views/elnido_view.php';
require_once 'controller/elnido_controller.php';
...
try {
    ...
    if (is_elnido_input_empty($package_key, $start_date, $end_date)) {
    ...
    if ($errors) {
        $_SESSION["errors_elnido"] = $errors;
        header("Location: ../elnido.php");
        die();
    }

    $totalDays = calculate_total_days($start_date, $end_date);
    $packageData = get_elnido_package_data($package_key);
